...
read_chunk("../../code/tpByVeg_CRU32.R")
```
...
The `tpByVeg_CRU32.R` script calculates mean temperature and precipitation over all grid cells in a CRU 3.1 map layer conditional of vegetation class using a given vegetation classification map.
