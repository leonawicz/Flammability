...
The `tpByVeg_CMIP5.R` script calculates mean temperature and precipitation over all grid cells in a CGM map layer conditional of vegetation class using a given vegetation classification map.
